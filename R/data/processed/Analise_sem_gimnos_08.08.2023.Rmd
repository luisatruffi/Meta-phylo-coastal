...
metadata <- read.csv("R/data/processed/tab.dist.filo.07.08.2023.csv")
...
data <- metadata[metadata$suitable_for_master_project=="yes", c("study2022", 
  "outcome", "reference", "pub_year", "location1", "location2","dd_lat", "dd_long", 
  "gradient2", "gai", "n_sp_LCVP", "n_family_LCVP", "n_lifeform3", "n_lifestage", "t_sp_LCVP", "t_family_LCVP", "t_lifeform3", "t_lifestage3", "lifeform1_similarity", "lifeform2_similarity",
  "lifestage_n_t", "performance2", "interaction_type","suitable_for_master_project",
  "suitable_master_reason", "MEANc", "MEANn", "SDc", "SDn", "Nc", "Nn",
  "SE_c", "SE_n", "sucess_c", "sucess_n", "fail_c", "fail_n", "data_type", "phylo_dist")]
...
```{r}
I2total.filo.abun <- (model.filo.abun$sigma2[1]+ model.filo.abun$sigma2[2]) / (model.filo.abun$sigma2[1] + model.filo.abun$sigma2[2] + v )

I2study.filo.abun <- model.filo.abun$sigma2[1] / (model.filo.abun$sigma2[1] + model.filo.abun$sigma2[2] + v)

I2effect.filo.abun <- model.filo.abun$sigma2[2]/(model.filo.abun$sigma2[1] + model.filo.abun$sigma2[2] + v)
```
...
```{r}
I2total.filo.grow <- (model.filo.grow$sigma2[1] + model.filo.grow$sigma2[2]) / (model.filo.grow$sigma2[1] + model.filo.grow$sigma2[2] + v )

I2study.filo.grow <- model.filo.grow$sigma2[1] / (model.filo.grow$sigma2[1] + model.filo.grow$sigma2[2] + v)

I2effect.filo.grow <- model.filo.grow$sigma2/(model.filo.grow$sigma2[1] + model.filo.grow$sigma2[2] + v)
```
...
```{r}
I2total.filo.rep <- (model.filo.rep$sigma2[1] + model.filo.rep$sigma2[2]) / (model.filo.rep$sigma2[1] + model.filo.rep$sigma2[2] + v )

I2study.filo.rep <- model.filo.rep$sigma2[1] / (model.filo.rep$sigma2[1] + model.filo.rep$sigma2[2] + v)

I2effect.filo.rep <- model.filo.rep$sigma2[2]/(model.filo.rep$sigma2[1] + model.filo.rep$sigma2[2] + v)
```
...
```{r}
I2total.filo.sur <- (model.filo.sur$sigma2[1] + model.filo.sur$sigma2[2]) / (model.filo.sur$sigma2[1] + model.filo.sur$sigma2[2] + v )

I2study.filo.sur <- model.filo.sur$sigma2[1] / (model.filo.sur$sigma2[1]+ model.filo.sur$sigma2[2] + v)

I2effect.filo.sur <- model.filo.sur$sigma2[2]/(model.filo.sur$sigma2[1] + model.filo.sur$sigma2[2] + v)
```
...
model.filo.for1.nogimno <-rma.mv(yi = effectsize, V= es_variance, random =(~1|study2022/outcome), 
       mods = ~phylo_dist*lifeform1_similarity,       data = data)
...
A <- predict(model.filo.for1.nogimno,newmods = cbind(seq(0,650, length = 100), 1, seq(0,650, length = 100)))
...
B <- predict(model.filo.for1.nogimno, newmods = cbind(seq(0,650, length = 100), 0, 0))
...
model.filo.for2.nogimno <-rma.mv(yi = effectsize, V= es_variance, random =(~1|study2022/outcome), 
       mods = ~phylo_dist*lifeform2_similarity,       data = data)
...
A2 <- predict(model.filo.for2.nogimno, newmods = cbind(seq(0,650, length = 100), 1, seq(0,650, length = 100)))
...
B2 <- predict(model.filo.for2.nogimno, newmods = cbind(seq(0,650, length = 100), 0, 0))
...
```{r}
model.filo.ontogenia.nogimno <- rma.mv(yi = effectsize, V= es_variance, random =(~1|study2022/outcome),mods = ~phylo_dist*lifestage_n_t,
...
```{r}
I2totalont <- (model.filo.ontogenia.nogimno$sigma2[1] + model.filo.ontogenia.nogimno$sigma2[2]) / (model.filo.ontogenia.nogimno$sigma2[1] + model.filo.ontogenia.nogimno$sigma2[2] + v )

I2studyont <- model.filo.ontogenia.nogimno$sigma2[1] / (model.filo.ontogenia.nogimno$sigma2[1] + model.filo.ontogenia.nogimno$sigma2[2] + v)

I2effectont <- model.filo.ontogenia.nogimno$sigma2[2]/(model.filo.ontogenia.nogimno$sigma2[1] + model.filo.ontogenia.nogimno$sigma2[2] + v)
...
N <- predict(model.filo.ontogenia.nogimno, newmods = cbind(seq(0,650, length = 100), 0, 0))
...
S <- predict(model.filo.ontogenia.nogimno, newmods = cbind(seq(0,650, length = 100), 1, seq(0,650, length = 100)))
...
```{r}
model_filo.duna <- rma.mv(yi = effectsize, V= es_variance, random =(~1|study2022/outcome), mods = ~phylo_dist*gradient2,       data = data[data$gradient2 == "1"| data$gradient2 == "2",])
model_filo.duna
...
```{r}
I2totalduna <- (model_filo.duna$sigma2[1] + model_filo.duna$sigma2[2]) / (model_filo.duna$sigma2[1] + model_filo.duna$sigma2[2] + v )

I2studyduna <- model_filo.duna$sigma2[1] / (model_filo.duna$sigma2[1] + model_filo.duna$sigma2[2] + v)

I2effectduna <- model_filo.duna$sigma2[2]/(model_filo.duna$sigma2[1] + model_filo.duna$sigma2[2] + v)
...
f <- predict(model_filo.duna, newmods = cbind(seq(0,650, length = 100), 0, 0))
...
m <- predict(model_filo.duna, newmods = cbind(seq(0,650, length = 100), 1, seq(0,650, length = 100)))
...
FALTOU AS ANALISES QUE PUS NO MATERIAL SUPLEMENTAR DA QUALIFICAÇÃO